...
<p align="center">
    <a href="https://skillicons.dev">
      <img src='https://skillicons.dev/icons?i=html,css,scss,react,js,ts,nodejs,express,jquery,md,mongodb,electron,discord,git,github,vscode,figma,discord,bots,vite,nestjs,graphql,mysql,tailwind,netlify,prisma,bots,devto,firebase,postman,python' />
    </a>
  </p>
</div>
